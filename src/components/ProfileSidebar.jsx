...
function ProfileSidebar() {
  ...
  return (
    <div className="hidden sm:block sm:w-36 md:w-64 h-screen flex-none overflow-y-auto border-r border-r-slate-400 text-center bg-light--gray">
      ...
      <div className="px-4 py-2 text-gray-700 hover:bg-orange hover:text-white">
        <Link to="/favorite">Favorilerim</Link>
      </div>
      <div className="flex justify-center items-center px-4 py-2 text-gray-700 hover:bg-orange hover:text-white border-t border-black my-4 ">
